...
class BespokeString {
	...
	pad() {
		const length = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 8
		const char = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ' '
	...
	inBox() {
		const options_ = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}
